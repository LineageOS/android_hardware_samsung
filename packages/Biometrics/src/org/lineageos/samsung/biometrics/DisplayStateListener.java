...
public class DisplayStateListener {
    private static final String TAG = "SB_DisplayStateListener";
    ...
    private final OnDisplayStateChangedListener mListener;
    ...
    private final IBiometricContextListener mContextListener =
            new IBiometricContextListener.Stub() {
                ...
                public void onDisplayStateChanged(int displayState) {
                    ...
                    mListener.onDisplayStateChanged(displayState);
                }
    ...
    public DisplayStateListener(Context context, OnDisplayStateChangedListener listener) {
        mContext = context;
        mListener = listener;
