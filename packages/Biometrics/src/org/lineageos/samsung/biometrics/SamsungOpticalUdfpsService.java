...
public class SamsungOpticalUdfpsService
        implements DisplayStateListener.OnDisplayStateChangedListener,
    ...
    public SamsungOpticalUdfpsService(Context context) {
        ...
        mUdfpsBrightness = Float.parseFloat(context.getResources().getString(
                R.string.config_Display_Solution_Udfps_Brightness));
        mUdfpsNits = Float.parseFloat(context.getResources().getString(
                R.string.config_Display_Solution_Udfps_Nits));
        ...
        byte[] bytes = Integer.toString((int) Math.round(mUdfpsBrightness))
