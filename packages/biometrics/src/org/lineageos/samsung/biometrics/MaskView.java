...
//      lp.gravity = Gravity.T    OP | Gravity.START;
    ...
    public void updateBackgroundColor(int displayBrightness) {
        ...
        float alpha = mDisplaySolution.getAlphaMaskLevel(displayBrightness, mDisplaySolution.mUdfpsBrightness, BRIGHTNESS_CONTROL_FACTOR);
        int maskAlpha = (int) (255f * alpha);
        int argb = (maskAlpha << 24);

        Log.i(TAG, "updateBackgroundColor: " + Integer.toHexString(argb) + ", " + mDisplaySolution.mUdfpsBrightness + ", " + maskAlpha);
