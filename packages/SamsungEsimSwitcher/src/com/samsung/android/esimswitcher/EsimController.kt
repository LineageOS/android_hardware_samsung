...
class EsimController private constructor(private val context: Context) {
     ...
     * ask the user to move it to the other slot first.
     *
    ...
    fun hasPhysicalSimInHybridSlot(): Boolean {
        ...
        if (DEBUG) {
            Log.d(TAG, "Physical SIM present in hybrid slot $EUICC_PHYSICAL_SLOT cardId=$cardId")
        }
        return true
    }
