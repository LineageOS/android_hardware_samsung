...
#if USE_SYSINPUT_HAL
    const std::string sehInstance =
            std::string() + ISehSysInputDev::descriptor + "/" + instanceName;
...
class SecUdfpsHelper {
  ...
  private:
     ...
     */
    static constexpr const char* FP_MASK_ENABLED =
            "/sys/devices/virtual/lcd/panel/finger_mask_state";
    static constexpr const char* FP_MASK_DEFAULT_BRIGHT =
            "/sys/devices/virtual/lcd/panel/finger_mask_brightness";
    static constexpr const char* HBM_BRIGHT_RO =
            "/sys/devices/virtual/lcd/panel/actual_mask_brightness";
