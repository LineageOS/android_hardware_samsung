...
int main(int argc, char** argv) {
    ...
    ndk::SpAIBinder health_binder = binder->asBinder();
    ndk::SpAIBinder sehhealth_binder = seh_health->asBinder();
    CHECK_EQ(STATUS_OK, AIBinder_setExtension(health_binder.get(), sehhealth_binder.get()))
