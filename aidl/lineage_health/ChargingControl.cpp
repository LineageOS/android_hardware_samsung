...
#if defined(HEALTH_CHARGING_CONTROL_LIMIT_START_PATH) && \
        defined(HEALTH_CHARGING_CONTROL_LIMIT_STOP_PATH)
        {HEALTH_CHARGING_CONTROL_LIMIT_START_PATH, HEALTH_CHARGING_CONTROL_LIMIT_STOP_PATH},
#else
