...
#define COMMON_MAX_COMPOSE_DELAY (1000)
#define COMMON_MAX_COMPOSE_EFFECT (32)
...
struct common_inputff_effects {
    struct common_inputff_effect effects[COMMON_MAX_COMPOSE_EFFECT];
    int num_of_effects;
