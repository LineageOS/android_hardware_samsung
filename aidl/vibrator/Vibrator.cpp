...
Vibrator::Vibrator() {
    ...
    if (mIsTimedOutVibrator) {
        CP_TRIGGER_EFFECTS[Effect::CLICK].second = getIntProperty("click" + kVibratorPropDuration, 10);
        CP_TRIGGER_EFFECTS[Effect::TICK].second = getIntProperty("tick" + kVibratorPropDuration, 5);
        CP_TRIGGER_EFFECTS[Effect::TEXTURE_TICK].second = getIntProperty("texture_tick" + kVibratorPropDuration, 5);
    } else {
