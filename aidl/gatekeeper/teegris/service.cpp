...
int main() {
    ...
    TEEC_AllocateSharedMemory = (void (*)(void**, struct shared_mem*))dlsym(
            libteecl_handle, "TEEC_AllocateSharedMemory");
    ...
    TEEC_ReleaseSharedMemory =
            (void (*)(struct shared_mem*))dlsym(libteecl_handle, "TEEC_ReleaseSharedMemory");
