...
int main() {
    ...
    // parse mNumPerfProfiles
    int32_t mNumPerfProfiles = android::base::GetIntProperty(kPowerHalProfileNumProp, 0);
    ...
    // lineage service
    std::shared_ptr<LineagePower> lineagePw = ndk::SharedRefBase::make<LineagePower>(hm, mNumPerfProfiles);
    ...
    binder_status_t lineageStatus = AServiceManager_addService(lineageInstance->asBinder().get(), lineageInstance.c_str());
