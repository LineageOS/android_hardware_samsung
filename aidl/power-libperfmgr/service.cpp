...
using LineagePower = aidl::vendor::lineage::power::Power;
...
int main() {
    ...
    int32_t mNumPerfProfilesTemp = android::base::GetIntProperty(kPowerHalProfileNumProp, 0);
    ...
    // lineage service
    std::shared_ptr<LineagePower> lineagePw = ndk::SharedRefBase::make<LineagePower>(mNumPerfProfilesTemp);
