 ...
 * device tree.
 */
// Where NVRAM calibration info is found, NULL if calibration unneeded
#define WIFI_DRIVER_NVRAM_PATH NULL

// Where NVRAM calibration parameters are found
#define WIFI_DRIVER_NVRAM_PATH_PARAM "/sys/module/wlan/parameters/nvram_path"

// Where the physical (MAC) address is found
#define MACADDR_PATH "/efs/wifi/.mac.info"

// Where the consumer identification number (CID) is found
