...
int main() {
    ...
    if (strncasecmp(mac_addr_half, "00:0e:6d", 9) == 0 ||
        ...
        strncasecmp(mac_addr_half, "10:5f:06", 9) == 0 || //~ Actiontec Electronics, Inc
        strncasecmp(mac_addr_half, "10:a5:d0", 9) == 0 ||
        strncasecmp(mac_addr_half, "10:d5:42", 9) == 0 || //~ Samsung Electronics Co.,Ltd
        ...
        strncasecmp(mac_addr_half, "78:52:1a", 9) == 0 || //~ Samsung Electronics Co.,Ltd
        strncasecmp(mac_addr_half, "60:21:c0", 9) == 0 ||
        strncasecmp(mac_addr_half, "88:30:8a", 9) == 0 ||
        strncasecmp(mac_addr_half, "c8:14:79", 9) == 0 || //~ Samsung Electronics Co.,Ltd
