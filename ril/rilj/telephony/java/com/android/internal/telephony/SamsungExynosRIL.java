...
public class SamsungExynosRIL extends RIL {
    ...
    protected int mSamsungNextGenModem = SystemProperties.getBoolean("ro.ril.samsung_nextgen_modem", false);
    // Property to determine whether the modem needs the videocall field or not. See BoardConfig.
    protected int mNeedsVideocallField = SystemProperties.getBoolean("ro.ril.needs_videocall_field", false);
