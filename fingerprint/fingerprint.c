...
static int load_bauth_server(void)
{
    ...
    *(void **)(&bauth_handle->ss_fingerprint_close) = dlsym(libhandle, "ss_fingerprint_close");
    *(void **)(&bauth_handle->ss_fingerprint_pre_enroll) = dlsym(libhandle, "ss_fingerprint_pre_enroll");
    *(void **)(&bauth_handle->ss_fingerprint_enroll) = dlsym(libhandle, "ss_fingerprint_enroll");
    *(void **)(&bauth_handle->ss_fingerprint_post_enroll) = dlsym(libhandle, "ss_fingerprint_post_enroll");
    *(void **)(&bauth_handle->ss_fingerprint_get_auth_id) = dlsym(libhandle, "ss_fingerprint_get_auth_id");
    *(void **)(&bauth_handle->ss_fingerprint_remove) = dlsym(libhandle, "ss_fingerprint_remove");
    *(void **)(&bauth_handle->ss_fingerprint_set_active_group) = dlsym(libhandle, "ss_fingerprint_set_active_group");
    *(void **)(&bauth_handle->ss_fingerprint_authenticate) = dlsym(libhandle, "ss_fingerprint_authenticate");
    *(void **)(&bauth_handle->ss_set_notify_callback) = dlsym(libhandle, "ss_set_notify_callback");
    *(void **)(&bauth_handle->ss_fingerprint_cancel) = dlsym(libhandle, "ss_fingerprint_cancel");
    *(void **)(&bauth_handle->ss_fingerprint_open) = dlsym(libhandle, "ss_fingerprint_open");
