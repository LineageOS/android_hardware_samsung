...
enum {
    ...
    SND_DEVICE_OUT_VOICE_EARPIECE_WIDEBAND,
    SND_DEVICE_OUT_VOICE_SPEAKER,
    SND_DEVICE_OUT_VOICE_SPEAKER_WIDEBAND,
    SND_DEVICE_OUT_VOICE_HEADPHONES,
    SND_DEVICE_OUT_VOICE_HEADPHONES_WIDEBAND,
    SND_DEVICE_OUT_HDMI,
    ...
    SND_DEVICE_IN_VOICE_EARPIECE_MIC_WIDEBAND,
    SND_DEVICE_IN_VOICE_SPEAKER_MIC,
    SND_DEVICE_IN_VOICE_SPEAKER_MIC_WIDEBAND,
    SND_DEVICE_IN_VOICE_HEADSET_MIC,
    SND_DEVICE_IN_VOICE_HEADSET_MIC_WIDEBAND,
    SND_DEVICE_IN_HDMI_MIC,
    SND_DEVICE_IN_BT_SCO_MIC,
    SND_DEVICE_IN_BT_SCO_MIC_WIDEBAND,
