...
#define CPU0_GOVERNOR_TUNABLES_PATH "/sys/devices/system/cpu/cpu0/cpufreq/interactive"
#define CPU4_GOVERNOR_TUNABLES_PATH "/sys/devices/system/cpu/cpu4/cpufreq/interactive"
