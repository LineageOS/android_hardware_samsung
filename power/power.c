...
#define CPU0_MAX_FREQ_PATH     CPU0_INTERACTIVE_PATH "/scaling_max_freq"
#define CPU4_MAX_FREQ_PATH     CPU4_INTERACTIVE_PATH "/scaling_max_freq"
#define CPU0_MIN_FREQ_PATH     CPU0_INTERACTIVE_PATH "/scaling_min_freq"
#define CPU4_MIN_FREQ_PATH     CPU4_INTERACTIVE_PATH "/scaling_min_freq"
                              ...
                              int profile)
{
    ...
    switch (profile) {
        ...
        case PROFILE_BIAS_POWER_SAVE:
            // TODO: Implement
            ALOGV("%s: NOT IMPLEMENTED: set powersave bias mode", __func__);
            break;
        case PROFILE_BIAS_PERFORMANCE:
            // TODO: Implement
            ALOGV("%s: NOT IMPLEMENTED: set performance bias mode", __func__);
            break;
        default:
                                  ...
                                  void *data)
{
    ...
    switch (hint) {
        ...
        case POWER_HINT_SUSTAINED_PERFORMANCE:
            ...
            set_power_profile(samsung_pwr, PROFILE_BIAS_PERFORMANCE);
            break;
