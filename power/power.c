...
#define BOOST_PATH             CPU0_GOVERNOR_TUNABLES_PATH "/boost"
#define BOOSTPULSE_PATH        CPU0_GOVERNOR_TUNABLES_PATH "/boostpulse"
#define IO_IS_BUSY_PATH        CPU0_GOVERNOR_TUNABLES_PATH "/io_is_busy"
#define CPU0_HISPEED_FREQ_PATH CPU0_GOVERNOR_TUNABLES_PATH "/hispeed_freq"
#define CPU4_HISPEED_FREQ_PATH CPU4_GOVERNOR_TUNABLES_PATH "/hispeed_freq"
