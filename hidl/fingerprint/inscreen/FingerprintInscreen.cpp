...
void FingerprintInscreen::requestResult(int, const hidl_string&) {
    // Ignore all results
}
...
Return<void> FingerprintInscreen::onPress() {
    ...
    mSecBiometricsFingerprintService->request(SEM_FINGER_STATE, 0, SEM_PARAM_PRESSED,
                                              hidl_string(SEM_AOSP_FQNAME),
                                              FingerprintInscreen::requestResult);
    return Void();
}

Return<void> FingerprintInscreen::onRelease() {
    mSecBiometricsFingerprintService->request(SEM_FINGER_STATE, 0, SEM_PARAM_RELEASED,
                                              hidl_string(SEM_AOSP_FQNAME),
                                              FingerprintInscreen::requestResult);
