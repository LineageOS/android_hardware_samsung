...
public class AdvancedDisplayFragment extends PreferenceFragment {
    private static final String TAG = "AdvancedDisplayConstants_Screen";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        /* mDNIe */
        mmDNIeScenario = (mDNIeScenario) findPreference(AdvancedDisplayConstants.KEY_MDNIE_SCENARIO);
        mmDNIeScenario.setEnabled(mDNIeScenario.isSupported(res.getString(R.string.mdnie_scenario_sysfs_file)));

        mmDNIeNegative = (mDNIeNegative) findPreference(AdvancedDisplayConstants.KEY_MDNIE_NEGATIVE);
