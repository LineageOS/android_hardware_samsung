...
struct private_handle_t {
     ...
     * passed to libMali.so. LibMali uses sNumInts for validation.
     * Enlarging numInts will do the trick to let native_handle_clone
     * clone the additional members.
     */
    ...
    static const int sExtraNumInts = 6;
